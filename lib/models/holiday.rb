...
class Holiday < ActiveRecord::Base
    ...
    def Holiday.due_date_from_(start_date, working_days)
    ...
    # Kicseréltem a fenti függvényt erre, hogy ne munkanapokban számoljon a rendszer
    def Holiday.due_date_from(start_date, _days)
        response_required_by = start_date.to_date + _days.to_i.day
        return response_required_by
    end

...
class OutgoingMessage < ActiveRecord::Base
    ...
    def get_default_letter
        ...
        if self.message_type.nil? || self.message_type == 'initial_request'
            ...
            " Kérem, hogy előzetesen elektronikus úton tájékoztasson arról, amennyiben a kért iratmásolatok szkenneléséért költségtérítés megállapítására kerül sor." +
            " Ebben az esetben kérem, hogy a tájékoztatásban mellékeljen dokumentumlistát, dokumentumonként tüntesse fel az oldalszámot és a szkennelés költségét.\n\n" +

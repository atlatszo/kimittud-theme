...
PublicBodyCategories.add(:hu, [ 
    "Közigazgatás",
        [ "központi","kormány, minisztériumok, kormányhivatalok","kormány, minisztériumok, kormányhivatalok"],
        [ "hatóság","hatóságok, felügyelőségek","hatóságok, felügyelőségek"],
    ...
    "Önkormányzatok",
        [ "önkormányzat","polgármesteri hivatalok és képviselőtestületek","polgármesteri hivatalok és képviselőtestületek"],
